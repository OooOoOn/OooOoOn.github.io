...
function validation() {
    ...
    var vNumber = document.getElementById("inputNumberBrowser").value.substring(3) ? document.getElementById("inputNumberBrowser") : document.getElementById("inputMobile");
